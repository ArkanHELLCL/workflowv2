...
!(function ($) {
    $.fn.mdbEditor = function (options,callback) {
            ...
            this.map(function (i, e) {
                var $tableId = $("#".concat($(e).closest(".wrapper-editor").find("table tbody").parent().attr("id"))),
                    ...
                    editorOptions = {
						...
						ajaxCallEdit: options.ajaxCallEdit,
						ajaxCallAdd: options.ajaxCallAdd,
						ajaxCallView: options.ajaxCallView,
						ajaxCallDelete: options.ajaxCallDelete,
                    },
                ...
                if ((startedStyleFunction(), $wrapperEditor.find("table th, .dataTables_paginate").on("click", sortingTable), !0 === options.modalEditor)) {
                    var $selectedRow,
						...
						$buttonView = $wrapperEditor.find(".buttonView"),
                        $buttonAddFormWrapper = $wrapperEditor.find(".buttonAddFormWrapper"),
                        //$buttonEditWrapper = $wrapperEditor.find(".buttonEditWrapper"),
						$buttonEditWrapper = $wrapperEditor.find(".buttonEdit"),
						//$buttonViewWrapper = $wrapperEditor.find(".buttonViewWrapper"),
						$buttonViewWrapper = $wrapperEditor.find(".buttonView"),
                        ...
                        toggleDisabledToButtons = function toggleDisabledToButtons(e) {
                            ($selectedRow = $(e.target).parent()),
                                $(e.target).parent().not("thead tr").not("tfoot tr").hasClass("tr-color-selected")
                                    ? ($buttonEdit.prop("disabled", !1), $buttonDelete.prop("disabled", !1), $buttonView.prop("disabled", !1), $createShowP.html("1 fila seleccionada"))
                                    : $("tr").hasClass("tr-color-selected") || ($buttonEdit.prop("disabled", !0), $buttonDelete.prop("disabled", !0), $buttonView.prop("disabled", !0), $createShowP.html("0 fila seleccionada"));
                        },
                        buttonEditInput = function buttonEditInput() {
						
							if (typeof callback == 'function') { // make sure the callback is a function
								if(editorOptions.ajaxCallEdit!="" && editorOptions.ajaxCallEdit!=undefined){
									var varValue;
									var varName;								
									var objeto={};

									for(var i= 0; i < editorOptions.numberofKeys; i++) {
										varValue=$DataTable.cell($selectedRow, i).data();									
										varName = "key"+(i+1);												
										objeto[varName]=varValue;									
									}									
									callback.call(objeto,editorOptions.ajaxCallEdit);
								}else{
						...
						buttonViewInput = function buttonViewInput() {
							
							if (typeof callback == 'function') { // make sure the callback is a function
								if(editorOptions.ajaxCallView!="" && editorOptions.ajaxCallView!=undefined){
									var varValue;
									var varName;								
									var objeto={};									
									...
									callback.call(objeto,editorOptions.ajaxCallView);
								}else{
									for (var _i2 = 0; _i2 < editorOptions.headerLength; _i2++) $DataTable.row($wrapperEditor.find(".modalEditClass input").eq(_i2).val($DataTable.cell($selectedRow, _i2).data()));
								}																
							}else{
                        ...
                        disabledButtons = function disabledButtons() {
                            $buttonEdit.prop("disabled", !0), $buttonDelete.prop("disabled", !0), $buttonView.prop("disabled", !0);
                        },
                        ...
                        buttonDeleteYes = function buttonDeleteYes() {
                            $buttonEdit.prop("disabled", !0), $buttonDelete.prop("disabled", !0), $buttonView.prop("disabled", !0),  $createShowP.html("0 fila seleccionada"), $DataTable.row($(trColorSelected)).remove().draw();
                        },
                        bindEvents = function bindEvents() {
                            $buttonAddFormWrapper.on("click", ".buttonAdd", addNewRows),
								...
								$buttonViewWrapper.on("click", $buttonView, buttonViewInput),
                                $buttonViewWrapper.on("click", $buttonView, addClassActiveToLabel),
                ...
                if (!0 === options.rowEditor) {
                    ...
                    var addNewTr = function addNewTr(e) {
                        ...
                        editRowAndAddClassToTr = function editRowAndAddClassToTr(e) {
                            for (
                                var $closestTrTd = $(e.target).closest(".wrapper-editor tr").find("td"),
                                    ...
                                    _i5 = 0;
                                _i5 < editorOptions.headerLength;
                                _i5++
                            )
                        ...
                        removeDisabledColorAdnTdYes = function removeDisabledColorAdnTdYes(e) {
                            ...
                            $closestTr.find(editRow).prop("disabled", !1),
                                ...
                                $DataTable.draw(!1),
                                $wrapperEditor.find("tbody tr").hasClass("tr-color-selected") || $wrapperEditor.find(".removeColumns").prop("disabled", !1);
                        },
                        ...
                        removeColorInTrAndDraw = function removeColorInTrAndDraw() {
                            $DataTable.row($wrapperEditor.find("tr.tr-color-selected")).remove().draw(!1),
                                $wrapperEditor.find("tbody tr").hasClass("tr-color-selected") ? $wrapperEditor.find($removeColumns).prop("disabled", !0) : $wrapperEditor.find($removeColumns).prop("disabled", !1);
                        },
                    ...
                    (function _bindEvents() {
                        ...
                        !0 === $closeByClick.hasClass("d-none") &&
                        ...
                        $wrapperEditor.find(".buttons-wrapper").on("click", ".addNewRows", function (e) {
                            ...
                            $("#".concat($(e.target).closest(".wrapper-editor").find("table").attr("id")))
                                .DataTable()
                                .row.add($newRow)
                                .draw();
                        });
                ...
                if (!0 === options.contentEditor) {
                    ...
                    var toggleBtnAndInputs = function toggleBtnAndInputs() {
                            $wrapperEditor.find("tbody").toggleClass("disabled-table"),
                                ...
                                $wrapperEditor.find("table tbody").hasClass("disabled-table") ? $wrapperEditor.find("input").prop("disabled", !0) : $wrapperEditor.find("input").prop("disabled", !1);
                        },
                        clickOnTd = function clickOnTd(ev) {
                            ...
                            if (
                                ("".concat($dtHeadTitle).includes("date") && !$this.children().hasClass("mdb-content-dynamic-input")
                                    ...
                                    : $this.children().hasClass("mdb-content-dynamic-input") ||
                                      ...
                                      focusInput(".mdb-content-dynamic-input")),
                                $wrapperEditor.find("td").children().length > 2)
                            ) {
                        ...
                        saveTdWhenSorting = function saveTdWhenSorting() {
                            for (var $DataTableNodeTd = $DataTable.column($(this)).nodes(), _i8 = 0; _i8 < $DataTableNodeTd.length; _i8++)
                                $($DataTableNodeTd[_i8]).children().length > 1 && $DataTable.cell($DataTableNodeTd[_i8]).data($($DataTableNodeTd[_i8]).children().closest(".mdb-content-dynamic-input").val()).draw(!0);
                        },
                        ...
                        removeFirstRowOrSelected = function removeFirstRowOrSelected() {
                            $wrapperEditor.find(".mdb-content-dynamic-input").length > 0
                                ? $DataTable
                                      .row($($wrapperEditor.find(".mdb-content-dynamic-input").parents().eq(1)))
                                      .remove()
                                      .draw(!0)
                                : $DataTable.row().remove().draw(!0);
                        },
                        _bindEvents2;
                ...
                if (!0 === options.bubbleEditor) {
                    ...
                    var nth = [
                        ...
                        $bubbleMainDiv = $("<div>", { class: "m-3 bubble-main d-flex-not-important flex-column" }),
                        $document = $(document),
                        inWords = function inWords(num) {
                    ...
                    $wrapperEditor.find(".buttons-wrapper").on("click", ".add-bubble-edit", function () {
                        var $this = $(this);
                        $this.children().hasClass("fa-toggle-off")
                              ...
                              $wrapperEditor
                                  ...
                                  .on("click", "td", function (ev) {
                                      ...
                                      if ($evTarget.html().match(/^\s*\d[\d,\.]*\s*$/))
                                          ...
                                          for (var $divToMainClass = $("<div class='".concat(bubbleMainClass, "'></div>")), _i10 = 0; _i10 < $evTarget.text().split(" ").length; _i10++)
                                              $(
                                                  $bubbleMainDiv.html(
                                                      $divToMainClass.append(
                                                          "<div class='d-flex flex-column wrapper-bubble-label-input'><label class='mt-2 mb-1'>"
                                                              .concat(inWords(_i10), " ")
                                                              .concat($dtHeadColumText, ":</label><div class='d-flex'><input type='text' class='text-left form-control' value='")
                                                              .concat(
                                                                  $evTarget
                                                                      .text()
                                                                      .split(" ")
                                      ...
                                      $('<div class ="bubble-bg"></div>').appendTo("body"),
                                          ...
                                          $('<span class="text-right position-absolute bubble-span-close" style="top:-8px; right:-8px;"><i class="fas fa-times-circle"></i></span>').prependTo(
                                              $('<button type="button" class="close text-right bubble-button-x"></button>').prependTo($bubbleMainDiv.prependTo($wrapperEditor))
                                          );
                                      ...
                                      $evTarget.addClass("tr-color-selected"),
                                          $bubbleMain.css({ top: ev.pageY - options.bubblePositionX, left: ev.pageX - options.bubblePositionY }),
                                          $document.find(".bubble-bg").length > 1 && $bubbleBg.not(":last").remove(),
                                          $wrapperEditor.find(".bubble-arrow").length > 1 && $bubbleArrow.not(":last").remove();
                                      var removeBubbleDarkBg = function removeBubbleDarkBg(e) {
                                          ...
                                          deleteClosestInputLabel = function deleteClosestInputLabel(e) {
                                              $wrapperEditor.find(".bubble-inside input").length > 1 && $(e.target).closest(".wrapper-bubble-label-input").remove(),
                                                  $wrapperEditor.find(".wrapper-bubble-input-delete").first().children().length < 2 &&
                                                      $wrapperEditor.find(".wrapper-bubble-input-delete").first().prepend("<i class='fas fa-plus-circle blue-text bubble-input-add-icon mt-2 mr-1'></i>");
                                          },
                                          addNewInput = function addNewInput(e) {
                                              var $eTarget = $(e.target),
                                                  $clondeDiv = $eTarget.parents().eq(2).clone(!0);

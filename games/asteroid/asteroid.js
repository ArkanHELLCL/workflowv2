//Ligth Mode Color
var colorParticle='#000',
	colorBullet='#000',
	colorAsteroid='#FF5900',
	colorTParticle='#000',
	colorShipExplosion='#000',
	colorAsteroidExplosion='#FF5900',
	colorCanvas="#fff",
	colorShip="#000",
	colorTrueScanLine='#222',
	colorFalseScanLine='#fff';
	document.getElementById("canvas").style.background = "#fff";
if (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches) {
	//Dark Mode Color
	var colorParticle='#FFF',
		colorBullet='#FFF',
		colorAsteroid='#FF5900',
		colorTParticle='#FFF',
		colorShipExplosion='#FFF',
		colorAsteroidExplosion='#FF5900',
		colorCanvas="#262626",
		colorShip="#fff",		
		colorTrueScanLine='#FFF',
		colorFalseScanLine='#222';
		document.getElementById("canvas").style.background = "#262626";
}
...
var Asteroid = (function()
{
	...
	var create = function()
	{
		var obj = Object.create(def);
		obj.radius = 40;
		obj.color = colorAsteroid;//'#FF5900';
		obj.pos = Vec2D.create(0, 0);
		obj.vel = Vec2D.create(0, 0);
		obj.blacklisted = false;
		obj.type = 'b';
...
function generateShipExplosion()
{
	...
	for(i; i > -1; --i)
	{
		...
		p.lifeSpan = 80;
		p.color = colorShipExplosion;//'#FFF';
...
function generateAsteroidExplosion(asteroid)
{
	...
	for(i; i > -1; --i)
	{
		...
		p.lifeSpan = 80;
		p.color = colorAsteroidExplosion;//'#FF5900';
		p.vel.setLength(20 / p.radius);
		p.vel.setAngle(ship.angle + (1 - Math.random() * 2) * doublePI);
...
function renderShip()
{
	...
	context.strokeStyle = colorShip;//'#FFF';
...
function renderScanlines()
{
	...
	for(i; i > -1; --i)
	{
		...
		context.strokeStyle = (Math.random() > 0.0001) ? colorTrueScanLine : colorFalseScanLine;
		context.stroke();
	}

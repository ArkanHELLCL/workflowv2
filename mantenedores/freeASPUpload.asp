	...
	Public Sub Upload()
		...
		on error resume next
			...
			if Err.Number <> 0 then 
				...
				response.write "The most likely cause for this error is the incorrect setup of AspMaxRequestEntityAllowed in IIS MetaBase. Please see instructions in the <A HREF='https://www.freeaspupload.net/freeaspupload/requirements.asp'>requirements page of freeaspupload.net</A>.<p>"
				Exit Sub
			end if
...
Class UploadedFile
    ...
    Public Property Let FileName(fN)
		...
		nameOfFile = SubstNoReg(nameOfFile, " ", "_")
		nameOfFile = SubstNoReg(nameOfFile, "á", "_")
		nameOfFile = SubstNoReg(nameOfFile, "é", "_")
		nameOfFile = SubstNoReg(nameOfFile, "í", "_")
		nameOfFile = SubstNoReg(nameOfFile, "ó", "_")
		nameOfFile = SubstNoReg(nameOfFile, "ú", "_")
		nameOfFile = SubstNoReg(nameOfFile, "Á", "_")
		nameOfFile = SubstNoReg(nameOfFile, "É", "_")
		nameOfFile = SubstNoReg(nameOfFile, "Í", "_")
		nameOfFile = SubstNoReg(nameOfFile, "Ó", "_")
		nameOfFile = SubstNoReg(nameOfFile, "Ú", "_")
		nameOfFile = SubstNoReg(nameOfFile, "ñ", "_")
		nameOfFile = SubstNoReg(nameOfFile, "Ñ", "_")

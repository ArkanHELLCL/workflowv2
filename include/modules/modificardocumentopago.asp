...
<%					
	...
	sql="exec spPagosRequerimientos_Modificar " & PAG_Id & "," & REQ_Id & ",'" & PAG_Descripcion & "'," & PAG_Mes & ",'" & PAG_FechaDescarga & "','" & PAG_FechaPublicacion & "','" & PAG_FechaEmision & "'," & PAG_NumeroFactura & "," & PAG_EstadoPago & "," & PRO_IdProveedor & "," & PAG_TipoDocumento & ",'" & PAG_OrdenCompra & "'," & PAG_Moneda & "," & PAG_MontoTotalFactura & "," & PAG_PorcentajeIva & ",'" & PAG_InfoExtra & "'," & PAG_Estado & "," & session("wk2_usrid") & ",'" & session("wk2_usrtoken") & "'"
